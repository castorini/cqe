...
python3 gen_query_tfrecord.py --query_file ../../trec/emb_search_for_CAsT/treccastweb/2020/cqr_manual_response_first_sent/query.tsv \
							   --vocab_file ../../trec/dl4marco-bert/models/uncased_L-12_H-768_A-12/vocab.txt \
							   --output_file ~/cast2019/tfrecord/cast2020_e2e_query_response